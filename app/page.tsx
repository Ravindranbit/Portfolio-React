                ...
                icon: (
                  <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center hover:bg-gray-50 transition-colors shadow-sm border border-gray-100">
                    <svg className="w-10 h-10" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M16.0008 2C9.37354 2 4 7.37354 4 16.0008C4 24.6265 9.37354 30 16.0008 30C22.6265 30 28 24.6265 28 16.0008C28 7.37354 22.6265 2 16.0008 2Z" fill="white"/>
                      <path d="M25.3288 6.35132C22.7547 3.77716 19.2453 2.33203 15.5859 2.33203H15.5547C11.8484 2.33203 8.30469 3.80859 5.70703 6.45312C3.14062 9.06641 1.71875 12.5547 1.75 16.2266C1.78125 22.2578 5.32422 27.6094 10.7539 30.0703L10.8164 29.9297C5.54688 27.5391 2.09375 22.3047 2.0625 16.2188C2.03125 12.5625 3.44531 9.09375 5.99609 6.49609C8.57812 3.86719 12.0859 2.40625 15.7734 2.40625H15.8047C19.4453 2.40625 22.9297 3.84375 25.4922 6.41016L25.3289 6.35156L25.3288 6.35132Z" fill="#2684FF"/>
                      <path d="M15.9453 6.67969L8.54297 14.082C7.75391 14.8711 7.75391 16.1523 8.54297 16.9414L15.9453 24.3438L23.3477 16.9414C24.1367 16.1523 24.1367 14.8711 23.3477 14.082L15.9453 6.67969ZM15.9453 21.3438L10.5977 15.9961C10.2578 15.6563 10.2578 15.1172 10.5977 14.8789L15.9453 9.53125L21.293 14.8789C21.6328 15.2188 21.6328 15.7578 21.293 15.9961L15.9453 21.3438Z" fill="#2684FF"/>
                      <defs>
                        <linearGradient id="jiraGrad" x1="15.9453" y1="6.67969" x2="15.9453" y2="24.3438" gradientUnits="userSpaceOnUse">
